...
### 下载
本仓库[下载地址](https://github.com/vectormoon/TheOneRing-CharacterCard/releases)下载 ```latest``` 版本的 ```TOR.zip```，解压后直接运行```TheOneRing-CharacterCard.html```文件即可
...
| `.lor[N]` | 技能加成骰 | `.lor3` | 结果为 d12 + 3d6 |
| `.lor[N]adv` | 优势骰 | `.lor3adv` | 在加成 3 的基础上取优势 |
| `.lor[N]dis` | 劣势骰 | `.lor3dis` | 在加成 3 的基础上取劣势 |
| `.lorm` | **博闻者**基础 d12 骰 | `.lorm` | 掷出一个 d12（11->12,12->0） |
