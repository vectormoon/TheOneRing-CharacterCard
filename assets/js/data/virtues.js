...
const cultureSpecificVirtuesData = {
    "巴德一族的人类": {
        ...
        "崇高命途（完成）": "传说中，河谷血脉的后裔生来便注定不凡，这一点，你的国王及其传奇经历已做出了最好的证明。并且，你证明了你继承了吉瑞安一脉的天命。\n使你的最大耐力上限和最大希望上限增加1点。",
...
const virtueBonusData = {
    "自信": { hope: 2 },
    "顽强": { endurance: 2, enduranceUsesWisdom: true },
    "机敏": { parry: 1 },
    "崇高命途": { endurance: 1 },
    "崇高命途（完成）": { endurance: 1, hope: 1 },
    "坚如磐石": { endurance: 1 },
    "坚韧不拔": { endurance: 1 },
    "游民之韧": { endurance: 1 },
    "不屈灵魂": { hope: 1 },
